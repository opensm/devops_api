...
# from apps.config.models import KubernetesModel
...
#         self.configuration.api_key = {"authorization": "Bearer {}".format("")}
...
#             pm = exc.problem_mark
#             raise ContentErrorException(
#                 message="{} has an issue on line {} at position {}".format(pm.name, pm.line, pm.column))
#         except Exception as error:
