...
from common.utils import get_group_obj_perms_model, get_identity, get_user_obj_perms_model
...
class ObjectPermissionChecker:
    ...
    def _prefetch_cache(self):
        from common.utils import get_user_obj_perms_model, get_group_obj_perms_model
