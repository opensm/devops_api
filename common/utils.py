...
from common.ctypes import get_content_type
from common.exceptions import NotUserNorGroup
...
def get_40x_or_None(
        request, perms, obj=None, login_url=None,
...
def get_user_obj_perms_model(obj=None):
    ...
    """
    from common.models import UserObjectPermissionBase
...
def get_group_obj_perms_model(obj=None):
    ...
    """
    from common.models import GroupObjectPermissionBase
